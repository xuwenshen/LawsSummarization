...
def construct_data(words_size, embedding_size, source_len, oseq_len, decoder_hidden, 
...
def decoder_rnn(conv_encoder, decoder_inputs, decoder_hidden, weigth_generation, 
                n_steps, bias_generation, batch_size, keep_prob,
                embedding, sample_rate, lstm_layer=1, is_train=True):
...
def build_model(words_size, embedding_size, oseq_len, source_len, simplified_len, defendant_nfilters, defendant_width,
                decoder_hidden, lstm_layer, batch_size, source_nfilters, source_width, is_train):    

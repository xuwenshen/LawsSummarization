...
class Generate(object):
    def __init__(self):
        ...
        self.saver.restore(self.sess, '/home/xuwenshen/2017_3_13/attention_cnn_lstm-lstm/model_v1/sample_rate-0.5-train_accu-0.000-train_cost-0.667-train_bleu-0.000-valid_accu-0.328-valid_cost-4.303-valid_bleu-0.681-model.ckpt-86')
